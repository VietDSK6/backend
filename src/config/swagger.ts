  ...
  definition: {
      ...
      schemas: {
        ...
        Event: {
          ...
          properties: {
            ...
            is_applied: { type: 'boolean', description: 'Chỉ có trong chi tiết sự kiện' },
            my_application: {
              nullable: true,
              description: 'Đơn đăng ký của user hiện tại, nếu có',
        ...
        Notification: {
          ...
          properties: {
            ...
            type: { type: 'string', enum: ['APPLICATION_CREATED', 'APPLICATION_APPROVED', 'APPLICATION_REJECTED', 'APPLICATION_COMPLETED', 'REVIEW_RECEIVED'] },
    ...
    paths: {
      ...
      '/applications/{id}/cancel': {
        patch: {
          tags: ['Applications'],
          summary: 'Huỷ đăng ký tham gia sự kiện (Student)',
          security: [{ BearerAuth: [] }],
          parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }],
          responses: { 200: { description: 'Đã huỷ đăng ký' }, 400: { description: 'Đơn không thể huỷ' }, 403: { description: 'Không có quyền huỷ đơn này' } },
        },
      },
